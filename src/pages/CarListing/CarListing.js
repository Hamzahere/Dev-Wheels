        ...
        >
          <div className="row pt-5">
            <div className="col-lg-3 col-md-6 mb-5">
              ...
              <p className="mb-2">
                <i className="fa fa-phone-alt text-white mr-3"></i>+012 345
                67890
              </p>
              <p>
            ...
            <div className="col-lg-3 col-md-6 mb-5">
              ...
              <div className="d-flex flex-column justify-content-start">
                ...
                <a className="text-body mb-2" href="#/">
                  <i className="fa fa-angle-right text-white mr-2"></i>New
                  Member Registration
                </a>
                <a className="text-body mb-2" href="#/">
                ...
                <a className="text-body" href="#/">
                  <i className="fa fa-angle-right text-white mr-2"></i>Help &
                  FQAs
                </a>
              </div>
            </div>
